...
namespace OpenRA.Platforms.Browser
{
	...
	static partial class OpenGL
	{
		...
		public static string glGetString(int name) => WebGLInterop.GlGetString(name);

		public static string glGetStringi(int name, uint index) => WebGLInterop.GlGetStringi(name, (int)index);
