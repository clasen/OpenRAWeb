...
{
	sealed class BrowserGraphicsContext : ThreadAffine, IGraphicsContext
	{
		readonly BrowserPlatformWindow window;

		public string GLVersion => OpenGL.Version;

		public BrowserGraphicsContext(BrowserPlatformWindow window)
		{
			this.window = window;
		}
